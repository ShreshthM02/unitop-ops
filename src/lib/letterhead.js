...
export const invoiceLetterheadCSS = `
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; -webkit-print-color-adjust: exact !important; print-color-adjust: exact !important; }
    ...
    .lh-header--fixed { position: fixed; top: ${PRINT_MARGIN.top}; left: ${PRINT_MARGIN.left}; right: ${PRINT_MARGIN.right}; padding-bottom: 0; }
    ...
    .lh-footer--fixed { position: fixed; bottom: ${PRINT_MARGIN.bottom}; left: ${PRINT_MARGIN.left}; right: ${PRINT_MARGIN.right}; padding-top: 0; }
