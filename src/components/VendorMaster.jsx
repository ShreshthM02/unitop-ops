            ...
            {editing?(
              ...
              <>
                ...
                <div style={{flex:1,overflowY:"auto",padding:16}}>
                  ...
                  {tab==="history"&&(()=>{
                    const assignments = getVendorAssignmentHistory(selected.id, tourExecutions, queries);
                    ...
                    return (
                      <div>
                        ...
                        {assignments.length===0?<div style={{textAlign:"center",padding:24,color:G.gray400,border:`1px dashed ${G.gray200}`,borderRadius:8,marginBottom:20,fontSize:12}}>No tours assigned yet. Assignments show here as soon as this vendor is added under a Tour File's Info → Others tab.</div>:(
