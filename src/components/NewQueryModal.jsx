      ...
      <div className="modal" style={{width:600}}>
        ...
        <div className="modal-body">
          ...
          <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:10,marginBottom:10}}>
            <div>
              ...
              <SearchableSelect
                ...
                options={agents}
                getValue={a=>a.id}
                getLabel={a=>`${a.company} (${a.country})`}
                placeholder="Type to search agents…"
                emptyLabel="— Select or type new —"
              />
            </div>
            <div>
          ...
          <div style={{display:"grid",gridTemplateColumns:"2fr 1fr 1fr",gap:10,marginBottom:10}}>
            ...
            <div>
              {sl("No. of Nights")}
              <input style={inp} type="number" value={form.nights} onChange={e=>set("nights",e.target.value)} placeholder="e.g. 3"/>
              {form.nights ? <div style={{fontSize:10,color:G.gray400,marginTop:2}}>{nightsDaysLabel(form.nights)}</div> : null}
            </div>
            <div>
              {sl("Hotel Category")}
