        ...
        return (
          <div key={stage.id}
            ...
            <div style={{flex:1,overflowY:"auto",padding:8,display:"flex",flexDirection:"column",gap:7}}>
              {cards.map(q => {
                const user = (staff||USERS).find(u => u.id === q.assignedTo);
                ...
                return (
                  <div key={q.id}
                    ...
                    <div style={{fontSize:12,fontWeight:600,color:"#1a1a1a",marginBottom:2,
                      ...
                      {q.groupName||q.clientName}<FileTypeBadge fileType={q.fileType}/>
                    </div>
                    {/* Destination */}
                    ...
                    <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",gap:4}}>
                      ...
                      <div style={{display:"flex",alignItems:"center",gap:5}}>
                        {q.travelDate && <span style={{fontSize:9,color:"#888"}}>{formatDateSlash(q.travelDate)}</span>}
