...
// Item 5: avatar photo upload removed entirely (repeated RLS failures,
// judged not worth continuing to debug). The two tests that used to
// live here (upload success, upload failure) are removed along with
// the feature itself -- they tested behavior that no longer exists,
